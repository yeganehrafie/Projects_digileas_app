...
import CategoriesSmartGadget from "../../categories/CategoriesSmartGadget";
import axios from "axios";

const ProductsSmartGadget: React.FC = () => {
    ...
    const [currentCategorySlug, setCurrentCategorySlug] = useState<string>("گجت-های-هوشمند");
    ...
    const categories = [
        { id: 1, name: "گجت های هوشمند", slug: "گجت-های-هوشمند" },
        { id: 2, name: "تصفیه کننده هوا", slug: "تصفیه-کننده-هوا" },
        { id: 3, name: "جارو رباتیک", slug: "جارو-رباتیک" },
        { id: 4, name: "شیکر شارژی", slug: "شیکر-شارژی" },
    ...
    // دریافت محصولات
    const fetchProducts = useCallback(async (page: number, append: boolean = false, categorySlug: string = "گجت-های-هوشمند") => {
    ...
    useEffect(() => {
        if (categorySlug) {
            ...
            setCurrentCategorySlug("گجت-های-هوشمند");
            setSelectedCategories([]);
            setProducts([]);
            setCurrentPage(1);
            setHasMore(true);
            fetchProducts(1, false, "گجت-های-هوشمند");
        }
    }, [categorySlug]);
    ...
    useEffect(() => {
        if (selectedCategories.length > 0) {
            ...
            if (currentCategorySlug !== "گجت-های-هوشمند") {
                setCurrentCategorySlug("گجت-های-هوشمند");
                setProducts([]);
                setCurrentPage(1);
                setHasMore(true);
    ...
    return (
        <>
            <div className="bg-white ">
                {/* BreadCrumb */}
                <BreadCrumb
                    title={'لیست محصولات گجت هوشمند  '}
                    items={[
                        { label: "صفحه اصلی", type: "home" },
                        { label: "محصولات گجت هوشمند" }
                    ]}
                    homePath="/"
                />
...
export default ProductsSmartGadget;