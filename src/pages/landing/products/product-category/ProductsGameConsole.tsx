...
const ProductsGameConsole: React.FC = () => {
    ...
    const [currentCategorySlug, setCurrentCategorySlug] = useState<string>("کنسول-بازی");
    ...
    const categories = [
        { id: 1, name: "کنسول بازی", slug: "کنسول-بازی" },
        { id: 2, name: "دسته بازی", slug: "دسته-بازی" },
        { id: 3, name: "XBOX", slug: "XBOX" },
        { id: 4, name: "PS4", slug: "PS4" },
        { id: 5, name: "PS5", slug: "PS5" },
    ];
    ...
    // دریافت محصولات
    const fetchProducts = useCallback(async (page: number, append: boolean = false, categorySlug: string = "کنسول-بازی") => {
    ...
    useEffect(() => {
        if (categorySlug) {
            ...
            setCurrentCategorySlug("کنسول-بازی");
            setSelectedCategories([]);
            setProducts([]);
            setCurrentPage(1);
            setHasMore(true);
            fetchProducts(1, false, "کنسول-بازی");
        }
    }, [categorySlug]);
    ...
    useEffect(() => {
        if (selectedCategories.length > 0) {
            ...
            if (currentCategorySlug !== "کنسول-بازی") {
                setCurrentCategorySlug("کنسول-بازی");
                setProducts([]);
                setCurrentPage(1);
                setHasMore(true);
...
export default ProductsGameConsole;